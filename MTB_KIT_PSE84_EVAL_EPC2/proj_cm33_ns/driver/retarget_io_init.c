...
*
* Description: Initialization routine for the retarget-io middleware.
*              Used by MicroPython port for serial I/O (REPL).
*              Adapted from Rutronik reference project.
*
* Note: DEBUG_UART_hal_obj is NOT static because MicroPython's mphalport.c
*       references it via extern for UART read operations.
*
******************************************************************************/
...
/* NOT static - mphalport.c needs extern access for mp_hal_stdin_rx_chr() */
