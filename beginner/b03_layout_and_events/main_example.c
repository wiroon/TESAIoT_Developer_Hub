...
static const menu_item_t s_items[] = {
    { "Flex Row",      LV_SYMBOL_RIGHT,    page_flex_row_create      },
    { "Flex Column",   LV_SYMBOL_DOWN,     page_flex_col_create      },
    { "Grid Layout",   LV_SYMBOL_LIST,     page_grid_create          },
    { "Card Layout",   LV_SYMBOL_IMAGE,    page_card_create          },
    { "Screen BG",     LV_SYMBOL_EYE_OPEN, page_screen_bg_create     },
    { "Custom Style",  LV_SYMBOL_EDIT,     page_custom_style_create  },
    { "Click Event",   LV_SYMBOL_OK,       page_click_event_create   },
    { "Value Changed", LV_SYMBOL_REFRESH,  page_value_changed_create },
    { "Long Press",    LV_SYMBOL_PAUSE,    page_long_press_create    },
    { "Multi Event",   LV_SYMBOL_BELL,     page_multi_event_create   },
    { "Timer Update",  LV_SYMBOL_LOOP,     page_timer_create         },
};
...
void example_main(lv_obj_t *parent)
{
    ...
    lv_label_set_text(lbl_title, "Layout & Events");
    ...
    lv_label_set_text(th_sub, "เลย์เอาต์และอีเวนต์");
