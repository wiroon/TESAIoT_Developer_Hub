...
static void timer_cb(lv_timer_t *timer)
{
    ...
    /* Update the live numeric readout */
...
void example_main(lv_obj_t *parent)
{
    ...
    lv_obj_set_size(s_chart, 700, 280);
    ...
    lv_obj_set_style_line_width(s_chart, 0, LV_PART_ITEMS);           /* hide point dots */
    ...
    /* Add a single series on the primary Y axis */
